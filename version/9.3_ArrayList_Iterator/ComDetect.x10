...
public class ComDetect 
{
    ...
    public  def checkArgs(args:Array[String])
    {
       ...
       // Console.OUT.println("args: size, filename, maxNode, edgeNum, it_random, precision, type_file, passTimes = " + args.size + ", " + filename + ", " + maxNode  + ", " + edgeNum+ ", " + it_random+ ", " + precision+ ", " + type_file+ ", " + passTimes);
    }
