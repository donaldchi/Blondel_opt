...
public class ComDetect_t 
{
	...
	public static def main(args:Array[String]) 
	{
        ...
        var cd:ComDetect_t = new ComDetect_t(); 
        cd.checkArgs(args);
        ...
        var com:Community_t = new Community_t(cd.filename, cd.type_file, cd.passTimes, cd.precision);     
        ...
        do{
            ...
            com = new Community_t(g, -1, cd.precision, com.inside_tmp);
