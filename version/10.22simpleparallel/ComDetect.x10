...
public class ComDetect 
{
	...
	public static def main(args:Array[String]) 
	{
        ...
        var com:Community = new Community(cd.filename, cd.type_file, cd.passTimes, cd.precision, cd.tNums);     
        ...
        do{
            ...
            com = new Community(g, -1, cd.precision, com.inside_tmp, com.tNums);
